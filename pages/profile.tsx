                ...
                <div className="avatar flex justify-center items-center">
                  <div className=" mb-3 items-center w-24 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                    <img
                      src={
                        ensAvatar ||
                        "https://www.hollywoodreporter.com/wp-content/uploads/2022/03/iger.jpg?w=1296"
                      }
                    />
                  </div>
                </div>
                      ...
                      <div className="w-2/3 p-4">
                        <div className="bg-white rounded-lg shadow-md p-4">
                          <h2 className="text-lg font-semibold text-black mb-4">
                            Your Points: {digiPoints} digiPoint(s){" "}
                          </h2>
                                  ...
                                  <tr>
                                    ...
                                    <th>
                                      <button
                                        ...
                                        className="btn btn-sm bg-red-900"
                                      >
                                        {inTxn ? (
                  ...
                  <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                    ...
                    >
                      ...
                      <div className="modal-action">
                        <span onClick={closeModal} className="btn">
                          Close
                        </span>
                      </div>
                      {gatewayError ? (
                        ...
                        <div>
                          <p>
                            ...
                            <Link
                              ...
                              href={`https://ens.app/${debouncedName}.digi-afrikan.eth`}
                            >
                              ENS Manager
                            </Link>{" "}
                            to see your name
