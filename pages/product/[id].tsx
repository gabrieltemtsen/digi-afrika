      ...
      <div className="pt-6 bg-blue-950 rounded-lg shadow-md p-4">
        ...
        <div className="mt-8 bg-gray-300  mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="text-3xl tracking-tight text-gray-900">{product.productPrice} celo {product.sold}</p>

            {product.sold ? (<span className='mt-3 badge badge-lg bg-green-700'>Item bought</span>) : (<button onClick={buyProduct} className='mt-2 btn btn-wide '>{inTxn ?
                 (  <span className="loading loading-infinity loading-lg">loading</span>): ('Purchase')}</button>)}

            <div className='mt-3'>
            {product.sold ? (<button className='mt-2 btn btn-wide '>File dispute</button>) : ('')}
            ...
            <div className='mt-3 text-black'>
              {product.owner == address && (
                   ...
                   <h1>Download Your Product here:   <a target='_blank' href={`https://ipfs.io/ipfs/${product.productFile}`} className='text-blue-500'>Product Link</a> </h1>
              )}
              </div>
